---
title: JavaScript - 이벤트 버블링과 이벤트 캡처링
date: 2021-12-07
tags:
    - Javascript
---

JavaScript에는 **click , keypress , focus , submit , scroll , load , change** 등 다양한 이벤트들이 있다. 만약 부모 요소와 자식 요소에 둘 다 같은 종류의 이벤트가 할당 되어있을 때, 이벤트를 동작시키면 어떤 이벤트가 먼저 실행될까?
